...
def main():
    ...
    assert cfg.DRNAS.METHOD in ['gdas', 'snas', 'dirichlet', 'darts'], "method not supported."
...
def train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, epoch):
    ...
    for step, (input, target) in enumerate(train_queue):
        ...
        # if epoch >= 15:
        architect.step(input, target, input_search, target_search, lr, optimizer, unrolled=cfg.DRNAS.UNROLLED)
        optimizer.zero_grad()
