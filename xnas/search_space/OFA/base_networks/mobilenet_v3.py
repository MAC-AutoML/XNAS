...
from xnas.search_space.OFA.utils.layers import (
    set_layer_from_config, MyNetwork, ResidualBlock,
    MBConvLayer, IdentityLayer, ConvLayer, LinearLayer,
)
from xnas.search_space.OFA.utils import make_divisible, MyGlobalAvgPool2d
