"""Evaluate model by NAS-Bench-301"""
...
try:
    ...
    print('Could not import NASBench301.')
    exit(1)
...
download_dir = cfg.BENCHMARK.NB301PATH
version = '0.9'


def init_model(version=0.9, download_dir=download_dir):
...
def evaluate(genotype):
    ...
    assert cfg.SPACE.NAME == "darts", "NAS-Bench-301 supports DARTS space only."
