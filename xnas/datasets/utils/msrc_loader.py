...
from xnas.datasets.utils.msrc_worker import worker_loop

__all__ = ["msrc_DataLoader"]
...
class msrc_DataLoader(Generic[T_co]):
    r"""
    ...
    def __setattr__(self, attr, val):
        ...
        super(msrc_DataLoader, self).__setattr__(attr, val)
...
class _BaseDataLoaderIter(object):
    def __init__(self, loader: msrc_DataLoader) -> None:
