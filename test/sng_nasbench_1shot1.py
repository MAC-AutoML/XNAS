...
class Reward(object):
    ...
    def get_accuracy(self,sample):
        #return test_accuracy of sample
        config=ConfigSpace.Configuration(self.space.get_configuration_space(), vector=sample)
...
def run(space=1, optimizer_name='SNG', budget=108, runing_times=500, runing_epochs=200,
    ...
    for i in tqdm.tqdm(range(runing_times)):
        ...
        for j in range(runing_epochs):
            ...
            rtime.append(step)
            step+=1
            rrecord.append(test_accuracy)
        plt.plot(np.array(rtime),np.array(rrecord))
        plt.show()
...
if __name__ == '__main__':
    ...
    #get nasbench
    nasbench_path='/Users/zhangshaokun/Projects/XNAS/nasbench_record/nasbench_full.tfrecord'
    ...
    step = args.step
    gamma = args.gamma
    save_dir = '/Users/zhangshaokun/Projects/XNAS/experiment'
    nasbench_path='/Users/zhangshaokun/Projects/XNAS/nasbench_record/nasbench_full.tfrecord'
